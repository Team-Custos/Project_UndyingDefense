        ...
        switch (SkillCode)
        {
            ...
            case 102://활 쏘기
                if (Bow != null && Bow.GetComponent<BowCtrl>() != null)
                {
                    ...
                    Bow.GetComponent<BowCtrl>().ArrowShoot(UnitCtrl.weaponCooldown, UnitCtrl.attackPoint, isEnemyAttack);
                }
                break;
        }
    }
    ...
    public void EnemyGeneralSkill(int SkillCode, Vector3 TargetPos)
    {
        switch (SkillCode)
        {
            ...
            case 102://활 쏘기
                ...
                {
                    Bow.transform.LookAt(TargetPos);
                    Bow.GetComponent<BowCtrl>().ArrowShoot(UnitCtrl.weaponCooldown, UnitCtrl.attackPoint, true);
                }
                break;
        }
    }
