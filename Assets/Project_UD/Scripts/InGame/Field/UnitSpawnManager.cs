...
public class UnitSpawnData
{
    ...
    public void InitFromUnitData(UnitDataManager.UnitData unitData)
    {
...
public class UnitSpawnManager : MonoBehaviour
{
    ...
    public GameObject UnitSpawn(int unitType,float X, float Y)
    {
        ...
        if (spawnData != null)
        {
            ...
            Obj.GetComponent<Ingame_UnitCtrl>().UnitInit(spawnData);
    ...
    {
        UnitDataManager.UnitData unitData = UnitDataManager.inst.GetUnitData(unitCode);
