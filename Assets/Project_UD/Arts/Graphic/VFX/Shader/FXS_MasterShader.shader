...
Shader "Amplify_Shader/VFX/Master_Shader_jsd"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 uv_Normal_Tex = v.ase_texcoord.xy * _Normal_Tex_ST.xy + _Normal_Tex_ST.zw;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float staticSwitch454 = IN.ase_texcoord4.x;
				#else
				float staticSwitch454 = _Main_Ins;
				#endif
				float4 temp_output_285_0 = ( ( pow( tex2DNode281.r , _Main_Power ) * staticSwitch454 ) * _Main_Color );
				...
				float2 staticSwitch338 = ( panner343 + IN.ase_texcoord4.z );
				#else
				float2 staticSwitch338 = panner343;
				#endif
				float temp_output_334_0 = ( tex2DNode281.r * pow( tex2D( _Mask_Tex, staticSwitch338 ).r , _Mask_power ) );
				...
				#endif
				float temp_output_435_0 = ( temp_output_334_0 * saturate( ( IN.ase_texcoord4.y + tex2D( _Dissolve_Tex, staticSwitch356.xy ).r ) ) );
				...
				float screenDepth446 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth446 = abs( ( screenDepth446 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( staticSwitch432 * IN.ase_color ).rgb;
				float Alpha = ( ( IN.ase_color.a * saturate( staticSwitch433 ) ) * saturate( distanceDepth446 ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 panner343 = ( 1.0 * _Time.y * appendResult344 + uv_Mask_Tex);
				#ifdef _MASK_TEXCOORD_CUSTOM_ON_ON
				float2 staticSwitch338 = ( panner343 + IN.ase_texcoord3.z );
				#else
				float2 staticSwitch338 = panner343;
				#endif
				float temp_output_334_0 = ( tex2DNode281.r * pow( tex2D( _Mask_Tex, staticSwitch338 ).r , _Mask_power ) );
				...
				float3 staticSwitch356 = ( temp_output_330_0 + float3( uv_Dissolve_Tex ,  0.0 ) );
				#endif
				float temp_output_435_0 = ( temp_output_334_0 * saturate( ( IN.ase_texcoord3.y + tex2D( _Dissolve_Tex, staticSwitch356.xy ).r ) ) );
				#ifdef _STEP_CUSTOM_ON
				float staticSwitch386 = ( temp_output_334_0 * step( _Step_Value , temp_output_435_0 ) );
				#else
				float staticSwitch386 = temp_output_435_0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 panner343 = ( 1.0 * _Time.y * appendResult344 + uv_Mask_Tex);
				#ifdef _MASK_TEXCOORD_CUSTOM_ON_ON
				float2 staticSwitch338 = ( panner343 + IN.ase_texcoord1.z );
				#else
				float2 staticSwitch338 = panner343;
				#endif
				float temp_output_334_0 = ( tex2DNode281.r * pow( tex2D( _Mask_Tex, staticSwitch338 ).r , _Mask_power ) );
				...
				float3 staticSwitch356 = ( temp_output_330_0 + float3( uv_Dissolve_Tex ,  0.0 ) );
				#endif
				float temp_output_435_0 = ( temp_output_334_0 * saturate( ( IN.ase_texcoord1.y + tex2D( _Dissolve_Tex, staticSwitch356.xy ).r ) ) );
				#ifdef _STEP_CUSTOM_ON
				float staticSwitch386 = ( temp_output_334_0 * step( _Step_Value , temp_output_435_0 ) );
				#else
				float staticSwitch386 = temp_output_435_0;
				...
				surfaceDescription.Alpha = ( ( IN.ase_color.a * saturate( staticSwitch433 ) ) * saturate( distanceDepth446 ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 panner343 = ( 1.0 * _Time.y * appendResult344 + uv_Mask_Tex);
				#ifdef _MASK_TEXCOORD_CUSTOM_ON_ON
				float2 staticSwitch338 = ( panner343 + IN.ase_texcoord2.z );
				#else
				float2 staticSwitch338 = panner343;
				#endif
				float temp_output_334_0 = ( tex2DNode281.r * pow( tex2D( _Mask_Tex, staticSwitch338 ).r , _Mask_power ) );
				...
				float3 staticSwitch356 = ( temp_output_330_0 + float3( uv_Dissolve_Tex ,  0.0 ) );
				#endif
				float temp_output_435_0 = ( temp_output_334_0 * saturate( ( IN.ase_texcoord2.y + tex2D( _Dissolve_Tex, staticSwitch356.xy ).r ) ) );
				#ifdef _STEP_CUSTOM_ON
				float staticSwitch386 = ( temp_output_334_0 * step( _Step_Value , temp_output_435_0 ) );
				#else
				float staticSwitch386 = temp_output_435_0;
...
/*ASEBEGIN
Version=19202
Node;AmplifyShaderEditor.CommentaryNode;265;-2196.476,170.1431;Inherit;False;1707.205;631.7745;Comment;21;416;387;351;350;349;348;347;333;332;330;329;328;327;326;325;324;323;322;321;438;439;Main_Distortion_Setting;1,0.7888081,0.6,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;332;-2116.039,338.1413;Inherit;False;Property;_Normal_Upanner;Normal_Upanner;19;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;333;-2112.097,410.9337;Inherit;False;Property;_Normal_Vpanner;Normal_Vpanner;20;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;328;-2145.427,640.9176;Inherit;False;Property;_Normal_Speed;Normal_Speed;23;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;329;-2146.476,512.2675;Inherit;False;Property;_Normal_Offset;Normal_Offset;22;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.StaticSwitch;325;-1592.62,354.9053;Inherit;False;Property;_Distortion_Custom;Distortion_Custom;21;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT2;0,0;False;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;321;-1320.219,335.4054;Inherit;True;Property;_Normal_Tex;Normal_Tex;16;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;416;-968.1745,429.9181;Inherit;False;Property;_Normal_Strength;Normal_Strength;18;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;266;-387.2501,257.3794;Inherit;False;1229.296;443.3408;Comment;20;319;318;317;316;309;305;304;302;301;300;298;294;290;284;283;282;281;440;431;454;Main_Setting;1,0.9824723,0.6,1;0;0
Node;AmplifyShaderEditor.WireNode;350;-800.0214,636.3443;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.CommentaryNode;263;-746.151,1329.333;Inherit;False;1668.875;640.5963;Comment;14;369;368;364;363;362;361;358;357;356;355;354;353;352;434;Dissolve_Setting;0.6,1,0.8287886,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;318;-340.7811,614.7202;Inherit;False;Property;_Main_Vpanner;Main_Vpanner;15;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;319;-350.2511,534.7206;Inherit;False;Property;_Main_Upanner;Main_Upanner;14;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;264;-642.639,706.3782;Inherit;False;1311.392;610.1761;Comment;15;391;390;346;345;344;343;339;338;337;336;335;342;451;453;306;Mask_Setting;0.7785853,1,0.6,1;0;0
Node;AmplifyShaderEditor.WireNode;363;-250.8341,1435.878;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;368;-694.5822,1855.93;Inherit;False;Property;_Dissolve_Vpanner;Dissolve_Vpanner;33;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;369;-695.743,1780.658;Inherit;False;Property;_Dissolve_Upanner;Dissolve_Upanner;32;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;345;-631.6,850.3782;Inherit;False;Property;_Mask_Upanner;Mask_Upanner;27;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;346;-631.4391,930.6495;Inherit;False;Property;_Mask_Vpanner;Mask_Vpanner;28;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;342;-560,736;Inherit;False;0;337;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;281;180.7999,307.7779;Inherit;True;Property;_Main_Tex;Main_Tex;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.PannerNode;343;-288,736;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.WireNode;300;439.429,386.6805;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;356;-86.35706,1558.665;Inherit;False;Property;_Dissolve_Panner_Custom;Dissolve_Panner_Custom;31;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StaticSwitch;338;-121.004,834.9229;Inherit;False;Property;_Mask_Texcoord_Custom_on;Mask_Texcoord_Custom_on;26;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT2;0,0;False;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;357;224.0659,1548.333;Inherit;True;Property;_Dissolve_Tex;Dissolve_Tex;29;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;337;211.7789,806.8707;Inherit;True;Property;_Mask_Tex;Mask_Tex;24;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;453;432,1008;Inherit;False;Property;_Mask_power;Mask_power;25;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;451;592,880;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;334;752,832;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;379;785.2349,1639.069;Inherit;False;Property;_Step_Value;Step_Value;35;0;Create;True;0;0;0;False;0;False;0.1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;386;1074.143,1507.048;Inherit;False;Property;_Step_Custom;Step_Custom;34;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;433;1305.061,1417.246;Inherit;False;Property;_USE_Dissolve_On;USE_Dissolve_On;30;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;449;1694,1166;Inherit;False;692;227;Comment;3;446;447;448;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;448;1744,1280;Inherit;False;Property;_DepthFade;DepthFade;37;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;405;1673.59,1699.309;Inherit;False;Property;_VertexNormal_Offset;VertexNormal_Offset;36;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;428;1741.691,865.2844;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DepthFade;446;1936,1232;Inherit;False;True;False;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;445;2544,800;Inherit;False;228;323;Comment;3;441;442;444;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SaturateNode;447;2208,1216;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;273;183.174,-124.9834;Inherit;False;Property;_Emmision_Ins;Emmision_Ins;10;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;291;-195.8251,58.21631;Inherit;False;Property;_Emission_Offset;Emission_Offset;12;0;Create;True;0;0;0;False;0;False;-0.5;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;305;481.6439,412.991;Inherit;False;Property;_Main_Power;Main_Power;6;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;275;373.975,-219.3839;Inherit;False;Property;_Sub_Color;Sub_Color;8;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;274;593.4142,-216.3531;Inherit;False;Property;_Main_Color;Main_Color;7;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;432;1106.389,92.43127;Inherit;False;Property;_USE_Sub_Color;USE_Sub_Color;9;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StaticSwitch;279;-297.821,-34.49109;Inherit;False;Property;_Color_UV_Custom;Color_UV_Custom;11;0;Create;True;0;0;0;False;0;False;0;0;0;True;;KeywordEnum;2;U;V;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;441;2592,848;Inherit;False;Property;_CullMode;CullMode;0;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.CullMode;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;442;2592,928;Inherit;False;Property;_SRC;SRC;1;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.BlendMode;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;444;2592,1008;Inherit;False;Property;_DST;DST;2;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.BlendMode;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;450;2144,960;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;251;193.9,789.7311;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;;0;0;Standard;0;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;252;2307.115,789.7311;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Amplify_Shader/VFX/Master_Shader_jsd;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_CullMode;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;3;True;12;all;0;True;True;2;5;True;_SRC;10;True;_DST;0;5;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;22;Surface;1;638442204140107906;  Blend;0;0;Two Sided;1;638731601386588927;Forward Only;0;0;Cast Shadows;0;638450590446273772;  Use Shadow Threshold;0;0;GPU Instancing;0;638763166008124916;LOD CrossFade;0;638763166012663712;Built-in Fog;0;638450591013986288;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;False;True;True;True;False;False;;False;0
Node;AmplifyShaderEditor.StaticSwitch;454;218.2887,591.2423;Inherit;False;Property;_USE_Ins_Custom;USE_Ins_Custom;5;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;306;18.53645,695.8957;Inherit;False;Property;_Main_Ins;Main_Ins;4;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;455;-264.8951,931.316;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;339;-639.655,1004.406;Inherit;False;1;4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;361;0;339;2
WireConnection;361;1;357;1
WireConnection;451;0;337;1
WireConnection;451;1;453;0
WireConnection;389;0;388;0
WireConnection;434;0;361;0
WireConnection;334;0;335;0
WireConnection;334;1;451;0
...
WireConnection;450;0;429;0
WireConnection;450;1;447;0
WireConnection;252;2;424;0
WireConnection;252;3;450;0
WireConnection;252;5;401;0
WireConnection;454;1;306;0
WireConnection;454;0;339;1
WireConnection;455;0;343;0
WireConnection;455;1;339;3
ASEEND*/
//CHKSM=F6CB96DE9ED9AD5BAE373A2A81CDECF6DABCB348