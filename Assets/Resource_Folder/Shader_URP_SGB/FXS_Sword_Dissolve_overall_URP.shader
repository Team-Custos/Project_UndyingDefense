...
Shader "Amplify Shader/SGB/URP/FX_Sword_Dissolve_Overall"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[HDR]_Base_color("Base_color", Color) = (3.291022,1.256324,1.256324,0)
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float fresnelNdotV79 = dot( ase_normalWS, WorldViewDirection );
				float fresnelNode79 = ( 0.0 + _Fresnel_Scale * pow( 1.0 - fresnelNdotV79, _Fresnel_Power ) );
...
Node;AmplifyShaderEditor.VertexColorNode;93;-1033.745,187.7466;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;95;-806.4932,417.8304;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;75;-2012.875,-430.9366;Float;False;Property;_Fresnel_Scale;Fresnel_Scale;4;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;76;-2028.562,-302.5866;Float;False;Property;_Fresnel_Power;Fresnel_Power;5;0;Create;True;0;0;0;False;0;False;4;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;77;-2115.134,101.5418;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;78;-2132.323,299.3046;Float;False;Property;_Color_Range;Color_Range;3;0;Create;True;0;0;0;False;0;False;0;-0.282;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FresnelNode;79;-1781.844,-398.9427;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;80;-1822.585,169.8695;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;84;-1691.531,137.6223;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;85;-1533.7,-358.2051;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;86;-1606.432,-584.9568;Float;False;Property;_Fresnel_color;Fresnel_color;6;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;581.2746,412.8921,104.1907,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;87;-1736.696,-167.7331;Float;False;Property;_Base_color;Base_color;2;1;[HDR];Create;True;0;0;0;False;0;False;3.291022,1.256324,1.256324,0;0.572327,0.4498317,0.1997744,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
